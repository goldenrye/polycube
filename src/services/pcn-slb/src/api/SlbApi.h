...
Response read_slb_server_id_by_id_handler(const char *name, const Key *keys, size_t num_keys);
...
Response update_slb_server_id_by_id_handler(const char *name, const Key *keys, size_t num_keys, const char *value);
